...
export default function Autenticacao() {
    ...
    function exibirErro(msg, tempoEmSegundo = 2) {
        setErro(msg)
    ...
    async function submeter() {
        try {
            ...
            exibirErro(e?.message ?? "Erro inexperado!!")
        }
    }
    ...
    return (
        <div className="flex h-screen items-center justify-center ">
            <div className={`hidden md:block md:w-1/2 lg:w-2/3`}>
                <img src="https://source.unsplash.com/random" alt="imgam da tela de autenticação" className={`h-screen w-full object-cover`} />
            </div>
            <div className="m-10 w-full md:w-1/2 lg:1/3">
                ...
                {erro ? (
                    <div className={`flex items-center bg-red-400 text-white py-3 px-5 border-2 border-red-700 rounded-lg`}>
                        {IconeAtencao}
                ...
                <AuthInput
                    ...
                    valorMudou={setSenha}
                    obrigatorio
                    naoRenderizarQuando={modo === 'login' ? true : false}
                />
